    ...
    while num > 1:
        ...
        for i in range(2, int(num**0.5) + 1):
            if num % i == 0:
                ...
                break
        if flag:
            print("Previous prime number is:", num)
            break
        num -= 1'''
...
for i in range(1, n + 1):
    if n % i == 0:
        ...
        # store first factor greater than 1
...
if sum_digits <= 1:
    ...
    for i in range(2, int(sum_digits**0.5) + 1):
        if sum_digits % i == 0:
            is_prime = False
            break
...
if sum_ls <= 1:
    ...
    for i in range(2, int(sum_ls**0.5) + 1):
        if sum_ls % i == 0:
            is_prime = False
            break
...
result = (zero_count + sum_digits) * smallest
